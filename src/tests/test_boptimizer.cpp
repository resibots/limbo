...
BOOST_AUTO_TEST_CASE(test_bo_gp)
{
    ...
    typedef opt::impl::InnerExhaustiveSearch<Params> InnerOpt_t;
    ...
    bayes_opt::BOptimizer<Params, modelfun<GP_t>, initfun<Init_t>, acquifun<Acqui_t>, inneropt<InnerOpt_t>, statsfun<Stat_t>, stopcrit<Stop_t>> opt;
...
BOOST_AUTO_TEST_CASE(test_bo_gp_auto)
{
    ...
    bayes_opt::BOptimizer<Params, modelfun<GP_t>, initfun<Init_t>, acquifun<Acqui_t>, inneropt<InnerOpt_t>, statsfun<Stat_t>, stopcrit<Stop_t>, optfun<opt_t>> opt;
    opt.optimize(fit_eval_map<Params>());
