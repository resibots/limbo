#ifndef LIMBO_EXPERIMENTAL_MODEL_POEGP_HPP
#define LIMBO_EXPERIMENTAL_MODEL_POEGP_HPP

#include <limbo/experimental/spt/spt.hpp>
...
namespace limbo {
    ...
    namespace experimental {
        namespace model {
            ...
            /// Crucial parameters:
            /// - Max number of samples per leaf of the Spatial Tree
            /// - Percentage of overlap between neighboring (in space) leafs
