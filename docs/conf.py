...
html_theme_options = {
    ...
    "toc_afters": [('Libdynamixel', 'http://www.resibots.eu/libdynamixel/'),
...
latex_documents = [
  (master_doc, 'limbo.tex', u'limbo Documentation',
   u'Jean-Baptiste Mouret, Antoine Cully', 'manual'),
]
...
man_pages = [
    (master_doc, 'limbo', u'limbo Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'limbo', u'limbo Documentation',
   author, 'limbo', 'One line description of project.',
   'Miscellaneous'),
]
